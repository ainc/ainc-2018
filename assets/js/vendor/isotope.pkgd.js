...
//Source: https://github.com/metafizzy/isotope/issues/1143
//NOTE: this is not included in the original plugin, added for use on alumni page
//fitRowsCentered layout mode
/*jshint browser: true, strict: true, undef: true, unused: true */
...
(function (window, factory) {
    ...
    if (typeof define == 'function' && define.amd) {
        // AMD
        define('isotope-layout/js/layout-modes/fitRowsCentered', [
            '../layout-mode'
        ],
            factory);
    } else if (typeof exports == 'object') {
