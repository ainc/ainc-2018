...
* Software: [Google Chrome](https://www.google.com/chrome/), [Unity - personal edition](https://store.unity.com/download?ref=personal)
* Accounts: [Google account](https://accounts.google.com) (Gmail, Google Drive, etc), [Unity account](https://id.unity.com/), [Mozilla Webmaker account](https://thimble.mozilla.org/en-US), [CodeCombat account](https://codecombat.com/) (get special class code from instructors)
...
* Next steps for learning
    1. Online resources: [Code.org](https://www.code.org), [Codecademy](https://www.codecademy.com/), [Udacity](https://www.udacity.com)
